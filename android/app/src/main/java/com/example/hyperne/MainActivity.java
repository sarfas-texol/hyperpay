...
public class MainActivity extends FlutterActivity implements ITransactionListener,MethodChannel.Result {
    // private static final String CHANNEL = "com.vy.vya/paymentMethod";
    MethodChannel.Result _result;

    private String  CHANNEL = "com.example.hyperne/paymentMethod";
    private String  CustomCHANNEL = "com.example.hyperne/channel";
...
//                            Log.d("brand",call.argument("brand"));
                            ...
                            if (type.equals("ReadyUI")){
                                ...
                                Toast.makeText(getBaseContext(),brands.toString(),Toast.LENGTH_LONG).show();
    ...
    private void openCheckoutUI(String checkoutId) {
        ...
        CheckoutSettings checkoutSettings =  new CheckoutSettings(checkoutId,paymentBrands,
                Connect.ProviderMode.TEST).setShopperResultUrl("com.example.hyperne://result");

        if (mode.equals("LIVE")) {
            checkoutSettings =  new CheckoutSettings(checkoutId,paymentBrands,
                    Connect.ProviderMode.LIVE).setShopperResultUrl("com.vya.vya://result");
        }
    ...
    private void openCustomUI(String checkoutid) {
        ...
        if (STCPAY.equals("enabled")) {
            ...
            try {
                ...
                paymentParams.setShopperResultUrl("com.vya.vya://result");
...
//    Log.println('1', "NewIntent", "=== INSIDE onNNewIntent ===");

        if (intent.getScheme().equals("com.vya.vya")) {
            Log.println('1', "NewIntent", "=== INSIDE onNNewIntent ===");
            success("success");
